! function(e, t) {
    ...
    var s = t.Slide,
        a = s.prototype.updateTarget;
    s.prototype.updateTarget = function() {
    ...
    var n = t.prototype;
    t.createMethods.push("_createFade"), n._createFade = function() {
        this.fadeIndex = this.selectedIndex, this.prevSelectedIndex = this.selectedIndex, this.on("select", this.onSelectFade), this.on("dragEnd", this.onDragEndFade), this.on("settle", this.onSettleFade), this.on("activate", this.onActivateFade), this.on("deactivate", this.onDeactivateFade)
    };
    var d = n.updateSlides;
    ...
    var h = n.positionSlider;
    n.positionSlider = function() {
        this.options.fade ? (this.fadeSlides(), this.dispatchScrollEvent()) : h.apply(this, arguments)
    };
    var o = n.positionSliderAtSelected;
    ...
    var r = n._getWrapShiftCells;
    n._getWrapShiftCells = function() {
        this.options.fade || r.apply(this, arguments)
    };
    var l = n.shiftWrapCells;
    return n.shiftWrapCells = function() {
